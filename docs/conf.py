...
sys.path.append(os.path.abspath('../controllers/odl_boron_pb/'))
sys.path.append(os.path.abspath('../controllers/odl_boron_sr2_pb/'))
...
project = u'NSTAT: Software Defined Network (SDN) Controller Handlers'
...
latex_documents = [
    (master_doc, 'nstatsrc.tex', u'NSTAT SDN Controller Handlers Documentation',
...
man_pages = [
    (master_doc, 'nstatsrc', u'NSTAT SDN Controller Handlers Documentation',
     [author], 1)
]
