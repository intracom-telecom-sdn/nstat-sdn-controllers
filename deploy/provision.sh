...
BASE_DIR="/opt"
VENV_DIR_NSTAT_SDN_CONTROLLERS="venv_nstat_sdn_controllers"
...
# NSTAT-SDN-CONTROLLERS node provisioning actions
#------------------------------------------------------------------------------
mkdir $BASE_DIR/$VENV_DIR_NSTAT_SDN_CONTROLLERS
virtualenv --system-site-packages $BASE_DIR/$VENV_DIR_NSTAT_SDN_CONTROLLERS

wget https://raw.githubusercontent.com/intracom-telecom-sdn/nstat-sdn-controllers/master/deploy/requirements.txt -P $BASE_DIR
source $BASE_DIR/$VENV_DIR_NSTAT_SDN_CONTROLLERS/bin/activate
